 ...
 * @author Ariel Yuri
 */
public class JFrameListaProdutos extends javax.swing.JFrame {

    /**
     * Creates new form JFrameListaMarcas
     */
    public JFrameListaProdutos() {
        initComponents();
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        new ProdutoDAO().popularTabela(tblProduto, tfdBuscar.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrameListaProdutos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFrameListaProdutos().setVisible(true);
            }
        });
    }
